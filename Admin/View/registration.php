    ...
    <body>
        ...
        <form action="../Control/registration_admin_control.php " method="post" enctype="multipart/form-data" onsubmit="return validation()">
            <table>
                ...
                <tr>
                    <td><h4> Gender:</h4></td>
                    <td><h4><input type="radio" name="AD_Gender" value="Male" id="AD_Gender">Male
                    <input type="radio" name="AD_Gender" id="AD_Gender" value="Female">Female
                    <input type="radio" name="AD_Gender" id="AD_Gender" value="Others">Others
                    </h4></td>
                ...
                <tr>
                    ...
                    <td><h4><input type="date" name="AD_dob" value="AD_dob" id="AD_dob"> </h4></td>
