<html>
    <head>
        ...
        <link rel="stylesheet" href="../CSS/style_Reg_MIN.css?v=<?php echo time(); ?>">
    </head>
    <body>
        <div class="container">
            <!-- Left-side image -->
            <div class="form-left">
                <img src="../Images/Min_Reg.jpg" class="min-reg" alt="Ministry Registration">
            </div>
            
            <!-- Right-side form -->
            <div class="form-container">
                <h1 class="page-title">Ministry Registration</h1>
                <form action="../Control/registration_ministry_control.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                    <table class="tbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <h4>
                                    <input type="radio" name="Min_gender" id="gender" value="Male"> Male
                                    <input type="radio" name="Min_gender" id="gender" value="Female"> Female
                                    <input type="radio" name="Min_gender" id="gender" value="Others"> Others
                                </h4>
                            </td>
