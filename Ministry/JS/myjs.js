...
function checkUserPic() {
  ...
  function validation() {
    if(checkFirstName()==false || checkLastName()==false ||checkMinistry()==false || checkGender()==false || checkEmail()==false || checkDate()==false || checkNID()==false|| checkNidFront()==false || checkNidBack()==false || checkUserPic()==false){
        return false;
    }
  } 