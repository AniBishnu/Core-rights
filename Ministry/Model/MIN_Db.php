...
class MyDB {
    ...
    function addUser($conObj, $table, $Min_email, $Min_dob, $Min_gender, $Min_Lastname, $Min_Firstname, $Min_nid, $Ministry, $MIN_NID_front, $MIN_NID_Back, $MIN_userpic) {
        // Insert NID Front and Back
        $queryNID = "INSERT INTO $table (Ministry, Min_NID_front, MIN_NID_Back, MIN_userpic ) VALUES (?, ?, ?, ?)";
        ...
        $stmtNID->bind_param
        ("ssss", $Ministry ,$MIN_NID_front, $MIN_NID_Back, $MIN_userpic);
        $stmtNID->execute();
