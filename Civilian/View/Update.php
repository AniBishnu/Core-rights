...
<html>
    ...
    <body>
        ...
        <legend><h2>Civilian Update</h2></legend>
        ...
        <table>
            ...
            <td><h4 id="districterror"></h4></td>
             ...
             <tr>
                ...
                <td><h4><input type="radio" name="agree" id="agree" Value="Yes">Yes
                <input type="radio" name="agree" id="agree" Value="No">No</h4></td>
